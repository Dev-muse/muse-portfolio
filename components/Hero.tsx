                ...
                <div className="flex flex-col items-center justify-center
                 max-w-[89vw] md:max-w-2xl lg:max-w-[60vw]">
                    ...
                    <TextGenerateEffect
                        ...
                        '
                        words='Your Digital Evolution
                         Starts Here.'
                    />
                    <p className="font-light text-center mb-4 md:tracking-widest
                    text-sm md:text-lg lg:text-xl ">
                        In a sea of bland websites, your business deserves to shine. Let&apos;s revolutionise your online presence, leaving cookie-cutter designs in the dust.
                    </p>
                    <a href="#about">
                        <MagicButton title='Let&apos;s Talk'
                            position='right' icon={<FaLocationArrow />}
                            otherClasses='gap-x-2' />
                    </a>
                </div>
            </div>
        </div>
